...
from acac.acac_marl.cores.acac import Learner_ACAC_Vanilla
...
class AgentCentricActorCritic_Vanilla(object):
    ...
    def __init__(self,
        ...
        self.controller = MAC(
            ...
            time_emb_dim=self.time_emb_dim, max_timestep=env_terminate_step, use_actor_ln=self.use_actor_ln, duplicate=self.duplicate,
        )
        ...
        # create learner
        self.learner = Learner_ACAC_Vanilla(self.env, self.controller, self.memory, gamma, obs_last_action, **hyper_params, **critic_params)
